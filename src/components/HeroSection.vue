    ...
    <div class="hero-content">
      ...
      <div class="hero-text">
        ...
        <div class="hero-actions">
          ...
          <!-- IOS -->
          <button class="hero-btn ios-btn disabled" disabled aria-disabled="true">
            <svg class="btn-icon" viewBox="0 0 24 24" fill="none">
...
// ✅ global:true pour accéder aux clés imbriquées HeroSection.xxx
...
.hero-btn.disabled { opacity: 0.6; pointer-events: none; }
...
.hero-note { width: 100%; margin-top: 0.5rem; color: rgba(255,255,255,0.6); }
